...
const content = {
 ...
 news: {
    ...
    videoLabel: { de: "Video ansehen", en: "Watch Video" },
    youtubeLabel: { de: "Auf YouTube ansehen", en: "Watch on YouTube" },
    list: [
      { tag: { de: "Veranstaltung", en: "Event" }, localVideo: true, title: { de: "Sommer BBQ 2026", en: "Summer BBQ 2026" },  text: { de: "Ein fröhliches Gemeinschaftsevent für alle Mitglieder und Freunde der GFSA-DO e.V.", en: "A joyful community event for all members and friends of GFSA-DO e.V." } },
